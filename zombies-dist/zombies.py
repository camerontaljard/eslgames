...
def gameloop():
  ...
  pygame.display.set_caption('Plants vs. Zombies Vers. 1.3 by CamGames')

  bg = pygame.image.load('bg-egypt-1024x768.jpg')
  ...
  characters = ('bluewatermelon.png','sherrifzombie.png',
		'coolpotato.png','hoodiezombie.png',
		'pea-pod-indi.png','sunwukong.png',
		'normzombie.png','snowpea.png',
		'aloevera.png')

  characterpoints = {0:500,1:-200,2:400,3:0,4:300,5:200,6:-100,7:100,8:50}

  TeamCharacters = ('team1.png','team2.png','team3.png','team4.png','team5.png','team6.png','team7.png','team8.png')
  ...
  bb = random.randint(0,8)
  cc = random.randint(0,8)
  dd = random.randint(0,8)
  ee = random.randint(0,8)
  ff = random.randint(0,8)
  gg = random.randint(0,8)
  hh = random.randint(0,8)
  ii = random.randint(0,8)
  jj = random.randint(0,8)
  kk = random.randint(0,8)
  ll =random.randint(0,8)
  mm = random.randint(0,8)
  nn = random.randint(0,8)
  oo = random.randint(0,8)
  pp = random.randint(0,8)
  qq = random.randint(0,8)
  rr = random.randint(0,8)
  ss = random.randint(0,8) 
  ...
  while True:
    ...
    #reset function
    resetfunc = winsurface.blit(reset, (940,0))
    
    #characters = ('bluewatermelon.png','coolpotato.png','pea-pod-indi.png','sunwukong.png','snowpea.png','aloevera.png','newszombie.png','normzombie.png','hoodiezombie.png','sherrifzombie.png')
    
    #points
    winsurface.blit(pygame.image.load('pbluewatermelon.png'), (200,0))
    label_bluewater = myfont.render("500", 1, red)
    winsurface.blit(label_bluewater, (200,45))
    
    winsurface.blit(pygame.image.load('pcoolpotato.png'), (300,0))
    label_cool = myfont.render("400", 1, red)
    winsurface.blit(label_cool, (300,45))
    
    winsurface.blit(pygame.image.load('ppea-pod-indi.png'), (360,0))
    label_pea = myfont.render("300", 1, red)
    winsurface.blit(label_pea, (360,45))
    
    winsurface.blit(pygame.image.load('psunwukong.png'), (440,0))
    label_sun = myfont.render("200", 1, red)
    winsurface.blit(label_sun, (440,45))
    
    winsurface.blit(pygame.image.load('psnowpea.png'), (540,0))
    label_snow = myfont.render("100", 1, red)
    winsurface.blit(label_snow, (540,45))
    
    winsurface.blit(pygame.image.load('paloevera.png'), (620,0))
    label_aloe = myfont.render("50", 1, red)
    winsurface.blit(label_aloe, (620,45))
    
    winsurface.blit(pygame.image.load('phoodiezombie.png'), (700,0))
    label_hood = myfont.render("0", 1, red)
    winsurface.blit(label_hood, (700,45))
    
    #winsurface.blit(pygame.image.load('pnewszombie.png'), (700,0))
    #label_news = myfont.render("-50", 1, red)
    #winsurface.blit(label_news, (700,0))
    
    winsurface.blit(pygame.image.load('pnormzombie.png'), (780,0))
    label_norm = myfont.render("-100", 1, red)
    winsurface.blit(label_norm, (780,45))
    
    winsurface.blit(pygame.image.load('psherrifzombie.png'), (860,0))
    label_sherrif = myfont.render("-200", 1, red)
    winsurface.blit(label_sherrif, (860,45))
  ...
  ###teams point mechanisim
    ...
    #dcircle = winsurface.blit(pygame.image.load(TeamCharacters[TeamDMascot]), (10,575))
    
    
    #acircle = pygame.draw.circle(winsurface,red,(100,200),50,0)
    #bcircle = pygame.draw.circle(winsurface,red,(100,300),50,0)
    #ccircle = pygame.draw.circle(winsurface,red,(100,400),50,0)
    #dcircle = pygame.draw.circle(winsurface,red,(100,500),50,0)
    ...
    #teamAlabel = myfont.render('Team A:', 1, black)
    #winsurface.blit(teamAlabel, (10,200))
    TeamApointsStr = myfontbig.render(str(TeamApoints),1,red)
    winsurface.blit(TeamApointsStr, (25,160))
    
    #teamBlabel = myfont.render('Team B:', 1, black)
    #winsurface.blit(teamBlabel, (10,375))
    TeamBpointsStr = myfontbig.render(str(TeamBpoints),1,red)
    winsurface.blit(TeamBpointsStr, (25,340))
    
    #teamClabel = myfont.render('Team C', 1, black)
    #winsurface.blit(teamClabel, (10,540))  
    TeamCpointsStr = myfontbig.render(str(TeamCpoints),1,red)
    winsurface.blit(TeamCpointsStr, (25,530))
    
    #teamDlabel = myfont.render('Team D', 1, black)
    #winsurface.blit(teamDlabel, (10,715))
    TeamDpointsStr = myfontbig.render(str(TeamDpoints),1,red)
    winsurface.blit(TeamDpointsStr, (25,720))
